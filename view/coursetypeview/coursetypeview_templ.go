...
var (
	taCourseTypeName     = schema.NewTA(courseTypeTN+"Name", "Name", schema.StringInput)
	taCourseTypeIsHidden = schema.NewTA(courseTypeTN+"IsHidden", "Is Hidden", schema.BooleanInput)
)

func getTableHeaders() []*schema.TableHeaderColumn {
	return []*schema.TableHeaderColumn{
		schema.NewTableHeaderColumn(taCourseTypeName.TATitle, 90),
		schema.NewTableHeaderColumn(taCourseTypeIsHidden.TATitle, 10),
	}
}
