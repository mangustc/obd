...
var (
	taProfLastname    = schema.NewTA(profTN+"Lastname", "Last name", schema.StringInput)
	taProfFirstname   = schema.NewTA(profTN+"Firstname", "First name", schema.StringInput)
	taProfMiddlename  = schema.NewTA(profTN+"Middlename", "Middle name", schema.StringInput)
	taProfPhoneNumber = schema.NewTA(profTN+"PhoneNumber", "Phone number", schema.StringInput)
	taProfEmail       = schema.NewTA(profTN+"Email", "Email", schema.StringInput)
	taProfIsHidden    = schema.NewTA(profTN+"IsHidden", "Is Hidden", schema.BooleanInput)
)

func getTableHeaders() []*schema.TableHeaderColumn {
	return []*schema.TableHeaderColumn{
		schema.NewTableHeaderColumn(taProfLastname.TATitle, 20),
		schema.NewTableHeaderColumn(taProfFirstname.TATitle, 20),
		schema.NewTableHeaderColumn(taProfMiddlename.TATitle, 20),
		schema.NewTableHeaderColumn(taProfPhoneNumber.TATitle, 15),
		schema.NewTableHeaderColumn(taProfEmail.TATitle, 15),
		schema.NewTableHeaderColumn(taProfIsHidden.TATitle, 10),
	}
}
