...
var (
	taStudentLastname    = schema.NewTA(studentTN+"Lastname", "Last Name", schema.StringInput)
	taStudentFirstname   = schema.NewTA(studentTN+"Firstname", "First Name", schema.StringInput)
	taStudentMiddlename  = schema.NewTA(studentTN+"Middlename", "Middle Name", schema.StringInput)
	taStudentPhoneNumber = schema.NewTA(studentTN+"PhoneNumber", "Phone Number", schema.StringInput)
	taGroupID            = schema.NewTA(groupTN+"ID", "Group", schema.OptionInput)
	taStudentIsHidden    = schema.NewTA(studentTN+"IsHidden", "Is Hidden", schema.BooleanInput)
)
...
func getTableHeaders() []*schema.TableHeaderColumn {
	return []*schema.TableHeaderColumn{
		...
		schema.NewTableHeaderColumn(taStudentPhoneNumber.TATitle, 20),
		schema.NewTableHeaderColumn(taGroupID.TATitle, 20),
		schema.NewTableHeaderColumn(taStudentIsHidden.TATitle, 10),
	}
}
